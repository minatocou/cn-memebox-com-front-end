...
(function($, window, document, undefined) {
	...
	Picker.prototype.init = function() {
		...
		if (isIos) {
			self.list.style.webkitTransformOrigin = "center center " + self.r*0.0625 + "rem";
		}
	};
	...
	Picker.prototype.calcElementItemPostion = function(andGenerateItms) {
		...
		self.elementItems.forEach(function(item) {
			...
			item.style.webkitTransformOrigin = "center center -" + self.r*0.0625 + "rem";
			item.style.webkitTransform = "translateZ(" + self.r*0.0625 + "rem) rotateX(" + (-self.endAngle) + "deg)";
			if (andGenerateItms) {
				var dataItem = {};
	...
	Picker.prototype.setAngle = function(angle) {
		...
		self.list.style.webkitTransform = "perspective("+125+"rem) rotateY(0deg) rotateX(" + angle + "deg)";
