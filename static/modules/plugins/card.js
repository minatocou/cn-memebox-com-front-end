...
(function(window, document, undefined) {
    ...
    LuckyCard.prototype.createCanvas = function() {
        var _this = this;
        _this.cover = document.createElement('canvas');
        _this.cover.style.position='relative';
        _this.cover.style.zIndex='100';
        _this.cover.id = 'cover';
        _this.cover.height = _this.cHeight;
        _this.cover.width = _this.cWidth;
        _this.ctx = this.cover.getContext('2d');
        if (_this.opt.coverImg) {

            var coverImg = new Image();
            coverImg.src = _this.opt.coverImg;
            coverImg.onload = function() {
                console.log(_this.cover.width,_this.cover.height)
        ...
        _this.scratchDiv.appendChild(_this.cover);
    }
